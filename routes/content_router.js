...
router.put("/content/:id",auth,auth_admin,content_controller.update_content)
router.put("/content_foto/:id",auth,auth_admin,multer().single('foto'),content_controller.update_foto)
router.put("/content_contoh_hasil/:id",auth,auth_admin,multer().single('contoh_hasil'),content_controller.update_contoh_hasil)
