...
router.post("/foto_sample/:id?",file_controller.foto_sample)
router.get("/download_jurnal_pendukung/:id",file_controller.download_jurnal_pendukung)
router.post("/jurnal_pendukung/:id?",file_controller.jurnal_pendukung)
...
router.post("/bukti_pembayaran/:id",file_controller.bukti_pembayaran)
